...
function getSmartComment(mode, step, text) {
    const comments = {
        ...
        owner: {
            1: [
                "💡【種別】物件種別に合わせた適切な賃料設定と効率的な募集体制が高稼働率の鍵となります！",
                "💡【種別】マンション・戸建てなど、各種別の強みを活かした賃貸運用プランをご提案します！",
                "💡【種別】ターゲット層に響く設備や条件を設定し、スムーズな入居者獲得を目指します✨"
            ],
            2: [
                "💡【エリア】周辺エリアの賃貸需要や競合物件を分析し、最適な募集条件・プランをご提示いたします！",
                "💡【エリア】地域ごとの賃料相場やターゲット属性を見極め、空室リスクを最小限に抑えます👍",
                "💡【エリア】エリア特性を反映した魅力的なプロモーションで、早期の満室稼働をサポートします！"
            ],
            3: [
                "💡【間取り】単身・ファミリーなど間取りごとの入居者ターゲットに合わせた設備訴求が効果的です！",
                "💡【間取り】ニーズの高い間取りのポイントを押さえ、賃料アップや長期入居につながる提案をします✨",
                "💡【間取り】ライフスタイルに合わせたお部屋の見せ方で、物件の魅力を引き出します！"
            ],
            4: [
                "💡【築年数・現況】築年数に応じた適切なリフォーム・設備交換提案で、物件価値を維持・向上させます！",
                "💡【築年数・現況】必要最小限の修繕で最大の賃料効果を生む、コスパの良い原状回復をご提案します👍",
                "💡【築年数・現況】経年変化に合わせたメンテナンス計画で、長期的に安定した賃貸経営を実現します！"
            ],
            5: [
                "💡【現況】現在の稼働状況に合わせた集客アプローチを行い、空室期間を短縮させます✨",
                "💡【現況】退去予告時期や現在の空室期間に応じたスピード感のある募集活動を展開します！",
                "💡【現況】現在の稼働状況を踏まえ、オーナー様に負担の少ない最適な運用方法を一緒に考えます！"
            ]
        },
        ...
        sell: {
            1: [
                "💡【種別】仲介での高値売却や買取での早期現金化など、ご事情に応じた売却戦略をご提示します！",
                "💡【種別】物件種ごとの市場需要を把握し、一番高く・良い条件で売却できるルートを探ります👍",
                "💡【種別】マンション・戸建て・土地それぞれの強みを活かしたプロモーションを展開いたします！"
            ],
            2: [
                "💡【エリア】近隣の最新成約事例や競合状況を分析し、高値かつスムーズに売れる適正価格をご提示します！",
                "💡【エリア】地域の購入意欲の高い層へピンポイントでアプローチし、好条件での売却を目指します✨",
                "💡【エリア】市場トレンドとエリアの魅力を掛け合わせた査定価格を算定いたします！"
            ],
            3: [
                "💡【広さ】お部屋の広さや使い勝手を活かし、最も購入意欲の高いターゲット層へアピールします！",
                "💡【広さ】ファミリー向けや単身向けなど、広さに合わせた訴求で買主様の心を掴みます👍",
                "💡【広さ】居住スペースの魅力や空間の広がりを最大限に伝えるPRを行います！"
            ],
            4: [
                "💡【現況・時期】居住中・空家の状態に応じた魅せ方や、買い替え時期・売却にかかる税金もサポートします！",
                "💡【現況・時期】売却のタイミングや控除等の税制メリットも踏まえ、一番手残りが多くなるご提案をします✨",
                "💡【現況・時期】ご希望の売却時期に合わせたスケジュールで、安心して進められるようお手伝いいたします！"
            ]
        },
        ...
        buy: {
            1: [
                "💡【種別】新築・中古それぞれの特徴や、将来の資産価値を見据えた失敗しない物件選びをお手伝いします！",
                "💡【種別】ご希望のライフスタイルに合い、長く安心して住める物件種別をご案内いたします👍",
                "💡【種別】将来の売却や賃貸出し（資産性）も視野に入れた価値ある物件選びをサポートします！"
            ],
            2: [
                "💡【予算】住宅ローンの金利タイプや税制優遇、諸費用も含めた無理のない資金計画をご提案いたします👍",
                "💡【予算】毎月のご返済額と総予算のバランスを整え、安心して購入できる範囲をご案内します✨",
                "💡【予算】事前審査から資金計画まで、失敗しないお金のシミュレーションをお手伝いします！"
            ],
            3: [
                "💡【間取り】将来のライフステージの変化にも柔軟に対応でき、資産性を維持できる間取りをご案内します！",
                "💡【間取り】ご家族の動線やプライベート空間を意識した、暮らしやすい間取りをご提案します✨",
                "💡【間取り】家具配置や日当たり・風通しなど、住み心地の良さを第一に考慮いたします！"
            ],
            4: [
                "💡【築年数】住宅ローン控除の適用条件や耐震基準の適合など、専門的なチェック項目もお伝えします！",
                "💡【築年数】新耐震基準やリノベーションの可能性も含め、安全で安心な物件を見極めます👍",
                "💡【築年数】築年数に応じた修繕履歴や管理体制もしっかりチェックしてご案内いたします！"
            ]
        }
    };
...
function getCurrentStepPrompt() {
    ...
    if (mode === "owner") {
        ...
        if (step === 6) return { text: "ご検討・ご希望の「管理スタイルやプラン」はございますか？", options: [{ text: "🤝 集客〜集金・管理まで全て任せたい", value: "full_manage" }, { text: "📢 集客（入居者募集）のみ依頼したい", value: "recruit_only" }, { text: "🛠️ 管理会社を変えたい", value: "sublease" }, { text: "💡 まずは賃料査定・相談のみ", value: "estimate_only" }] };
    ...
    if (mode === "sell") {
        ...
        if (step === 4) return { text: "現在の「物件のご利用状況やご売却時期」を教えてください。", options: [{ text: "👤 自身で居住中（早期売却希望）", value: "living_now" }, { text: "🚪 現在、空家・空室", value: "empty" }, { text: "💰 賃貸中（オーナーチェンジ）", value: "rented" }, { text: "🗓 良い条件があれば時期問わず検討", value: "someday" }] };
        if (step === 5) return { text: "ご売却に関する「その他ご要望」があれば教えてください！\n\nほかにも気になる点がございましたら、下のメッセージ入力欄から送信してください。\n特になければ、下記ボタンよりお問合せへお進みください！", options: [{ text: "📝 条件を引き継いでお問合せへ進む", value: "contact", isPrimary: true }] };
    }
    ...
    if (mode === "buy") {
        ...
        if (step === 3) return { text: "ご希望の「間取りや広さ」はいかがでしょうか？", options: [{ text: "🛋 1LDK〜2DK", value: "1ldk" }, { text: "🛋 2LDK〜3LDK", value: "3ldk" }, { text: "🏠 4LDK以上", value: "4ldk" }, { text: "🏬 一棟・事業用", value: "business" }] };
        if (step === 4) return { text: "「築年数」のご希望はございますか？", options: [{ text: "✨ 新築・築浅（10年以内）", value: "new" }, { text: "🏢 築20年以内", value: "under20" }, { text: "🛠 リノベーション前提", value: "renovation" }, { text: "⚖️ 特に拘らない", value: "any" }] };
        if (step === 5) return { text: "ご希望エリアやローン相談など「ご要望」はございますか？\n\nほかにも気になる点がございましたら、下のメッセージ入力欄から送信してください。\n特になければ、下記ボタンよりお問合せへお進みください！", options: [{ text: "📱 条件を引き継いでお問合せへ進む", value: "contact", isPrimary: true }] };
    }
...
function getAIResponse(userInputText) {
    ...
    // --------------------------------------
    // A. FAQ・脱線質問への回答（ステップを進めず同じ質問を再送）
    // --------------------------------------
